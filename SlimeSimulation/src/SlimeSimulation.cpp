...
void SlimeSimulation::PrepareCubePipeline()
{
    ...
    shaderStages[0] = Utils::LoadShader(m_logicalDevice, "../../shaders/cube.vert.spv", VK_SHADER_STAGE_VERTEX_BIT);
    shaderStages[1] = Utils::LoadShader(m_logicalDevice, "../../shaders/cube.frag.spv", VK_SHADER_STAGE_FRAGMENT_BIT);
...
void SlimeSimulation::PrepareParticlePipeline()
{
    ...
    shaderStages[0] = Utils::LoadShader(m_logicalDevice, "../../shaders/particle.vert.spv", VK_SHADER_STAGE_VERTEX_BIT);
    shaderStages[1] = Utils::LoadShader(m_logicalDevice, "../../shaders/particle.frag.spv", VK_SHADER_STAGE_FRAGMENT_BIT);
...
void SlimeSimulation::PrepareCompute()
{
    ...
    computePipelineCreateInfo.stage = Utils::LoadShader(m_logicalDevice, "../../shaders/simulation.comp.spv", VK_SHADER_STAGE_COMPUTE_BIT);
